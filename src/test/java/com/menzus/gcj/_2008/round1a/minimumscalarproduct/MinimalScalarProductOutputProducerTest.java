...
public class MinimalScalarProductOutputProducerTest {
    private MinimalScalarProductOutputProducer outputProducer;

    @Before
    public void before() {
	outputProducer = new MinimalScalarProductOutputProducer();
    }
